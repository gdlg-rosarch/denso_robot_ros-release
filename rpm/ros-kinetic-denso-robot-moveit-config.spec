Name:           ros-kinetic-denso-robot-moveit-config
Version:        3.0.2
Release:        1%{?dist}
Summary:        ROS denso_robot_moveit_config package
...
for using the DENSO robots with the MoveIt Motion Planning Framework
...
%changelog
* Sun Dec 24 2017 MoveIt Setup Assistant <assistant@moveit.ros.org> - 3.0.2-1
- Autogenerated by Bloom

* Sun Dec 17 2017 MoveIt Setup Assistant <assistant@moveit.ros.org> - 3.0.2-0
- Autogenerated by Bloom

* Fri Dec 08 2017 MoveIt Setup Assistant <assistant@moveit.ros.org> - 3.0.1-0
- Autogenerated by Bloom
